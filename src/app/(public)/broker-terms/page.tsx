    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">
              Legal document: Terms of Use for Brokers
            </p>
          </div>
        </div>
      </header>
          ...
          <article className="legal-content">
            <ReactMarkdown
              components={{
                ...
                h2: ({ children }) => (
                  <h2 className="text-2xl font-bold text-slate-900 border-b border-slate-200 pb-3 mb-4 mt-8">
                    {children}
                  </h2>
                ),
                h3: ({ children }) => (
      ...
      <footer className="bg-slate-50 border-t py-6 mt-8">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-sm text-slate-500">
            © {new Date().getFullYear()} Brokwise Private Limited
          </p>
