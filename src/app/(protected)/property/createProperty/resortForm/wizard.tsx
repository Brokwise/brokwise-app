...
import { ResortBasicInfo } from "./steps/resort-basic-info";
import { ResortSpecs } from "./steps/resort-specs";
      ...
      component: (
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <ResortSpecs form={form} enquiry={enquiry} />
          </div>
          <div className="w-full h-px bg-border" />
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-primary">
