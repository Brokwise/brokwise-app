...
interface FarmhousePropertySpecsProps {
  form: UseFormReturn<FarmHousePropertyFormData>;
  enquiry?: Enquiry;
}

export const FarmhousePropertySpecs: React.FC<FarmhousePropertySpecsProps> = ({
  form,
  enquiry,
}) => {
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="flex items-center gap-2">
                  ...
                  {lastEditedPriceField === "totalPrice" && size && size > 0 && (
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="flex items-center gap-2">
                  Total Price (₹)
                  {lastEditedPriceField === "rate" && size && size > 0 && (
                    <span className="text-xs font-normal text-blue-500 bg-blue-50 px-2 py-0.5 rounded-full">
                      Auto-calculated
                    </span>
                  )}
