...
import { Factory, Warehouse, LandPlot } from "lucide-react";
...
interface IndustrialBasicInfoProps {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  form: any;
  enquiry?: Enquiry;
}

export const IndustrialBasicInfo: React.FC<IndustrialBasicInfoProps> = ({
  form,
  enquiry,
}) => {
