...
const SIDEBAR_WIDTH = "clamp(15rem, 18vw, 20rem)"
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-background md:bg-sidebar p-0 text-foreground md:text-sidebar-foreground [&>button]:hidden  pt-[7.5vh] md:pt-0 rounded-r-xl"
            style={
              {
